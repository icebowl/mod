...
var SekindoClientDetections_URL = function (config) {
	...
	this._getTagContainerSizeInfo = function()
	{
		...
		containerInfo['urlParams'] = '&x=768&y=1024';
		containerInfo['xLen'] = 768;
		containerInfo['yLen'] = 1024;
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=95336&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=800&y=542&vp_content=plembedbc1rugspthjo&vp_template=3379&cbuster=1565992886',
					origQString: 's=95336&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=800&y=542&vp_content=plembedbc1rugspthjo&vp_template=3379',
					x: 800,
					y: 542,
					isSlider: false,
					isOutstream: false,
					...
					float: {enabled: true,
						...
						direction: 'br', verticalOffset: 100,
						horizontalOffset: 10, isCloseBtn: 1},
					isAPI: false,
					inGdprIsRequired: 0,
					inGdprRawConsent: '',
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"69.0","browserVersionMajor":"69","browserVersionMinor":"0"},"browser":"firefox","os":"linux","osVer":"","deviceType":"desktop"},
					geo: 'US',
					dynamicSetup: [],
					uuid: '5d461f6f1279d',
